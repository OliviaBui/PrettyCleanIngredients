...
#########################################
# 🏛Allergen dictionaries & found_allergens 🏛️🏛️🏛️🏛️🏛️🏛️🏛️🏛️🏛️🏛🏛️🏛️🏛️🏛️️🏛️🏛️🏛️🏛️🏛️🏛️🏛️🏛️🏛🏛️🏛️🏛️🏛️🏛️🏛️🏛️🏛️🏛️🏛️🏛️🏛️
#########################################
allergen_categories = {
...
#########################################
# 🌿 Establishing selectedallergens dictionary - ONLY the categories the user chooses 🌿🌿🌿🌿🌿🌿🌿🌿🌿🌿🌿🌿🌿🌿🌿
#########################################
...
#########################################
# 🧼 FUNCTION: Cleaning ingList from '/', duplicates, whitespace, commas, invalid inputs) 🧼🧼🧼🧼🧼🧼🧼🧼🧼🧼🧼🧼🧼
#########################################
...
#########################################
# 🫧 FUNCTION: More cleaning, removing odd characters 🫧🫧🫧🫧🫧🫧🫧🫧🫧🫧🫧🫧🫧🫧🫧🫧🫧🫧🫧🫧🫧🫧🫧🫧🫧🫧🫧🫧🫧🫧
#########################################
...
#########################################
# 💁‍♂️ FUNCTION: Widget frame clearing️ 💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️💁‍♂️
#########################################
...
#############################
# 🔮Page: Allergen check "Select your allergens" 🔮🔮🔮🔮🔮🔮🔮🔮🔮🔮🔮🔮🔮🔮🔮🔮🔮🔮🔮🔮🔮🔮🔮🔮🔮🔮🔮🔮🔮🔮🔮🔮🔮
#############################
def display_allergenCheck(root, frame):
    ...
    #########################################
    # 🌟 FUNCTION: Delete custom allergen  🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟
    #########################################
    ...
    update_allergen_list()
#########################################
#  🦄 FUNCTION: Finding allergen matches when comparing ingList + selectedallergens 🦄 🦄 🦄 🦄 🦄 🦄 🦄 🦄 🦄 🦄 🦄 🦄 🦄
#########################################
...
#########################################
# 🌺 Main application setup: root, geometry, title, frame, starting on home page, looping 🌺🌺🌺🌺🌺🌺🌺🌺🌺🌺🌺🌺🌺🌺
#########################################
